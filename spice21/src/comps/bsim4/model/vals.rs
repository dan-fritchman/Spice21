...
pub(crate) fn resolve(specs: &Bsim4ModelSpecs) -> Bsim4ModelVals {
    ...
    // FIXME: many of these LDE-size parameters are disabled, 
    // due to problems elsewhere in our `proto` setup. 
    // All will be set to their default values, which are all zero. 
